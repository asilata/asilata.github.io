...
:properties:
:comment: In progress.
:link: [[file:assets/papers/2026-palindromic.pdf][pdf]]
:end:
...
:properties:
:with: Daria Poliakova
:comment: In progress.
:end:

** Wigglyhedra for planar point sets
:properties:
:with: David Alcántara, Marguerite Bin, Natasha Crepeau, Hoi Luk, Vincent Pilaud, Francisco Santos
:comment: In progress.
:end:
