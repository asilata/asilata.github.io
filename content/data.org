...
:description: ANR
:amount: EUR 404,305
:location: ANU (IRL-FAMSI)
:comment: Partner investigator on grant led by Hoel Queffelec. Other members are Agnes Gadbled, Thomas Gobet, Thomas Haettel, Anthony Licata, Luis Paris, Anne-Laure Thiel,   Emmanuel Wagner, Bert Wiest.
:end:
...
** A Khovanov homology approach to Khovanov--Seidel categories
:properties:
:with: [[https://hqueffel.pages.math.cnrs.fr/][Hoel Queffelec]]
:comment: In progress.
:end:

** Geometric models of stability conditions via braid pictures
:properties:
:with: Prognadipto Majumder
:comment: In progress.
:end:

** A cubic construction of the wiggly lattice
:properties:
:with: [[https://sites.google.com/view/daria-poliakova][Daria Poliakova]]
:comment: In progress.
:end:

** Wigglyhedra for planar point sets
:properties:
:with: David Alcántara, Marguerite Bin, Natasha Crepeau, Hoi Luk, [[https://www.ub.edu/comb/vincentpilaud/][Vincent Pilaud]], [[https://personales.unican.es/santosf/][Francisco Santos]]
:comment: In progress.
:end:

** Additive friezes
:properties:
:with: Véronique Bazier-Matte, Eleonore Faber, Kunda Kambaso, Bethany Marsh, Yadira Valdivieso
:comment: In progress.
:end:
...
* Papers                                                              :paper:
** On the language of palindromic reduced expressions in a Coxeter group
:properties:
:comment: Preprint.
:link: [[file:assets/papers/2026-palindromic.pdf][pdf]], [[https://arxiv.org/abs/2609.29022][arXiv]]
:end:
...
:year: 2025
:slug: wiggly
:link: [[file:assets/papers/2025-bapat-pilaud-wiggly.pdf][pdf]], [[https://arxiv.org/abs/2407.11632][arXiv]], [[https://link.springer.com/article/10.1007/s00209-025-03688-9][journal]]
:end:
...
:comment: Groups, Geometry, and Dynamics (accepted, to appear).
:slug: unfaithful
...
:properties:
:with: [[http://www.robinwalters.com/][Robin Walters]]
:comment: Preprint (not for publication). Parts of this paper were published as the paper titled "The strong topological monodromy conjecture for Coxeter hyperplane arrangements".
:year: 2015
:link: [[http://arxiv.org/abs/1503.01055][arXiv]]
:end:

** The lower central series quotients of a free associative superalgebra
:properties:
:comment: Final paper for undergraduate research project (SPUR), mentored by David Jordan. An expanded version of this document was later published as "Lower central series of free algebras in symmetric tensor categories".
:year: 2015
:link: [[file:assets/papers/2009-bapat-lcq.pdf][pdf]]
:end:
...
:properties:
:with: Hoel Queffelec
:comment: This sage code attempts to find counterexamples to the faithfulness of the Burau representation in various types. 
:link: [[https://github.com/asilata/burau-faithfulness][github]]
:end:
...
* Activities                                                       :activity:
** [[https://sites.google.com/view/facets-2027][FACETS conference]]
SCHEDULED: <2027-02-01 Mon>
:properties:
:location: Sydney Mathematical Research Institute
:type: other
:comment: co-organised with Edmund Heng, Anne Thomas, Oded Yacobi
:end:
...
:type: other
:comment: co-organised with Ana Balibanu, Teena Gerhardt, Iva Halacheva, Padmavathi Srinivasan, and Kirsten Wickelgren
:end:

** [[https://sites.google.com/cam.ac.uk/st-meets-rt-april-2026/home][Symplectic topology meets representation theory]] :sphericals:wiggly:
SCHEDULED: <2026-04-24 Fri>
:properties:
:shorttitle: Cambridge
:location: University of Cambridge
:type: presentation
:link: [[file:assets/slides/2026-cambridge-notes.pdf][notes]]
:end:
...
** [[https://www.icts.res.in/program/stability][ICTS workshop on Geometric Structures and Stability]]        :sphericals:
...
:properties:
:location: ANU Kioloa Campus
:type: other
:comment: co-organised with Anthony Licata, James Tener, Oded Yacobi
:end:
** Combinatorial Geometries and Geometric Combinatorics IRP Seminar :sphericals:wiggly:
SCHEDULED: <2025-11-18 Tue>
:properties:
:shorttitle: Barcelona
:location: Centre de Recerca Matemàtica, Barcelona
:type: presentation
:link: [[file:assets/slides/2025-11-18-crm.pdf][notes]]
:end:

** [[https://www.crm.cat/irp-mdm-112025/][Combinatorial Geometries and Geometric Combinatorics]]
...
SCHEDULED: <2025-06-24 Tue 12:00-13:00>
:properties:
:shorttitle: UNSW
:location: UNSW
:type: presentation
:link: [[file:assets/slides/2025-06-24-unsw.pdf][slides]]
:end:
...
* Teaching                                                         :teaching:
** Coxeter groups reading course (special topics course)
SCHEDULED: <2026-02-23 Mon>
:properties:
:location: Australian National University
:display-date: 2026 Semester 1
:end:
...
:status: future
:end:
- Supervising [[https://tanishatalekar.github.io][Tanisha Talekar]]'s PhD project.
- Co-organising the [[https://sites.google.com/view/facets-2027][FACETS 2027 conference]] with Edmund Heng, Anne Thomas, and Oded Yacobi.
  
** Semester 2, 2026
- Posted a preprint titled "On the language of palindromic reduced words in a Coxeter group", available as a [[file:assets/papers/2026-palindromic.pdf][pdf]] and also on the [[https://arxiv.org/abs/2609.29022][arXiv]].
- Supervising [[https://tanishatalekar.github.io][Tanisha Talekar]]'s PhD project.
- Supervising Akihiro Katsuta's Honours project.
- Participating in a working seminar on Bridgeland stability and K3 surfaces.
- Coordinating the Simon Marais Mathematics Competition at ANU with [[https://comp-math-econ.academy/index_.html][Yun Kuen (Marco) Cheung]].
...
- Supervising [[https://tanishatalekar.github.io][Tanisha Talekar]]'s PhD project.
- Supervising Akihiro Katsuta's Honours project.
- Teaching a reading course on Coxeter groups.
- Participating in a working seminar on mapping class groups and Artin--Tits groups.
- Attending a working seminar on multiplicative Slodowy slices and affine Springer fibres.
- Organised a working bee called "Shut up and prove!".
...
- Participating in a seminar on Hochschild (co)homology.
...
- Supervising Tanisha Talekar's PhD project.
- Organising an end-of-year MSI picnic at Black Mountain Peninsula Park!
- Organising a workshop at Kioloa with Tony Licata, James Tener, Oded Yacobi.
