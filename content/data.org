...
:properties:
:comment: Lecturer (tenure track).
:date: 2018–
:end:

** University of Georgia
:properties:
:comment: Limited-term assistant professor.
:date: 2016–2017
:end:
...
:properties:
:date: 2010–2016
:comment: M.S. in Mathematics (June 2012). PhD in Mathematics (June 2016). Advised by Victor Ginzburg.
:end:

** Massachusetts Institute of Technology
:properties:
:date: 2006–2010
:comment: B.S. in Mathematics with Computer Science.
:end:

* Career interruptions                                        :interruptions:
** Maternity leave
:properties:
:date: Jul 2019–Jan 2020
:end:

* Grants and awards                                                  :awards:
** Dean's commendation for Excellence in Education (for Teaching Excellence)
:properties:
:date: 2021
:location: ANU
:end:
...
** Nadine Kowalsky Prize
:properties:
:date: 2016
:location: UChicago
:end:

** DAAD (German Academic Exchange Service) short-term research grant
:properties:
:date: 2015
:end:

** Jerry Rao Fellowship
:properties:
:date: 2014–2015
:location: UChicago
:end:
...
** Rogers prize for best paper, Summer Program in Undergraduate Research
:properties:
:date: 2009
:location: MIT
:end:

** Indian National Mathematical Olympiad scholarship
:properties:
:date: 2005
:end:

** Gold and silver medals, International Astronomy Olympiad, as a member of the Indian delegation
:properties:
:date: 2003, 2005
:end:

* Research outputs
** Morse-based fibering of the persistence rank invariant              :paper:
:properties:
...
** \(q\)-deformed rational numbers and the 2-Calabi--Yau category of type \(A_{2}\) :paper:
:properties:
...
** A Thurston compactification of the space of stability conditions    :paper:
:properties:
:with: [[https://deopurkar.github.io][Anand Deopurkar]], [[https://maths-people.anu.edu.au/~licatat/Home.html][Anthony Licata]]
:comment: Preprint.
:slug: thurston
...
** Recollement for perverse sheaves on real hyperplane arrangements    :paper:
:properties:
:slug: recollement
...
** The strong topological monodromy conjecture for Coxeter hyperplane arrangements :paper:
:properties:
:slug: bfunctions
...
** Torus actions and tensor products of intersection cohomology        :paper:
:properties:
:slug: torus
...
** The Bernstein-Sato \(b\)-function of the Vandermonde determinant      :nfp:
:properties:
:with: [[http://mathserver.neu.edu/~robin/][Robin Walters]]
...
** Lower central series of free algebras in symmetric tensor categories :paper:
:properties:
...
** Equivariant cohomology and the localization theorem                   :nfp:
:properties:
...
** The sphere of spherical objects                                :inprogress:
:properties:
:with: [[https://deopurkar.github.io][Anand Deopurkar]], [[https://maths-people.anu.edu.au/~licatat/Home.html][Anthony Licata]]
:comment: In progress.
:slug: sphericals
...
** Categorical braid group actions                                      :code:
:properties:
...
* Activities                                                       :activity:
** [[https://pages.uoregon.edu/belias/QUACKSII/index.html][QUACKS II]]
...
** [[https://sites.google.com/view/quivers-in-physics][Quivers, representation theory, and physics]]
SCHEDULED: <2022-09-07 Wed>
:properties:
:location: The University of Cologne
:category: presentation
:end:
