...
\email{asilata.bapat@anu.edu.au} \homepage{asilatabapat.org} \phone{02 6125 7320}
\date{\today}
...
\label{sec:org873d332}
\begin{itemize}
\item On the language of palindromic reduced expressions in a Coxeter group\\
\emph{Preprint.}
\item A sphere of spherical objects (with \href{https://deopurkar.github.io}{Anand Deopurkar}, \href{https://maths-people.anu.edu.au/\~licatat/Home.html}{Anthony Licata})\\
...
\emph{Groups, Geometry, and Dynamics (accepted, to appear).}
...
\section*{Grants}
\label{sec:orgc82fd1c}
\cventry{2026--2030}{ANR (EUR 404,305)}{Catégories, Géométrie, Tresses (CaGeT)}{ANU (IRL-FAMSI)}{}{Partner investigator on grant led by Hoel Queffelec. Other members are Agnes Gadbled, Thomas Gobet, Thomas Haettel, Anthony Licata, Luis Paris, Anne-Laure Thiel,   Emmanuel Wagner, Bert Wiest.}
...
\section*{Teaching}
\label{sec:org0aa9dd6}
\subsection*{Australian National University}
\label{sec:org14aea11}
\begin{itemize}
\item \textbf{2026 Semester 1}: Coxeter groups reading course (special topics course)
...
\label{sec:orgc37e709}
\begin{itemize}
\item \textbf{Apr 2026}: \href{https://sites.google.com/cam.ac.uk/st-meets-rt-april-2026/home}{Symplectic topology meets representation theory}, University of Cambridge
\item \textbf{Feb 2026}: \href{https://www.icts.res.in/program/stability}{ICTS workshop on Geometric Structures and Stability}, ICTS Bengaluru
\item \textbf{Nov 2025}: Combinatorial Geometries and Geometric Combinatorics IRP Seminar, Centre de Recerca Matemàtica, Barcelona
\item \textbf{Jun 2025}: UNSW pure maths seminar, UNSW
