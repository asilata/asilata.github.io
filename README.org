...
Since the github container's org version is **old**, we have to go overkill and reinstall org.
This will (understandably) take forever, so I will eventually run this in a docker emacs container as described [[https://duncan.codes/posts/2019-09-03-migrating-from-jekyll-to-org/][here]].
